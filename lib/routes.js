...
FlowRouter.route('/ammodesc',{
	name: 'ammodesc',
	action() {
		BlazeLayout.render('ammodesc');
	}
...
FlowRouter.route('/Effectsdesc',{
	name: 'Effectsdesc',
	action() {
		BlazeLayout.render('effectsdesc');
	}

});

FlowRouter.route('/Abilitiesdesc',{
	name: 'Abilitiesdesc',
	action() {
		BlazeLayout.render('abilitiesdesc');
	}
