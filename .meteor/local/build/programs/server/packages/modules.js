...
install("amdingo:bootstrap-duallistbox");
install("semantic:ui");
install("flemay:less-autoprefixer");
install("natestrauser:x-editable-bootstrap");
install("fortawesome:fontawesome");
install("twbs:bootstrap-noglyph");
...
install("babrahams:editable-text-wysiwyg-bootstrap-3");
