...
install("reactive-dict");                                                                                    // 62
install("kadira:flow-router");                                                                               // 63
install("deps");                                                                                             // 64
install("htmljs");                                                                                           // 65
...
install("kadira:blaze-layout");                                                                              // 70
install("amdingo:bootstrap-duallistbox");                                                                    // 71
install("semantic:ui");                                                                                      // 72
install("flemay:less-autoprefixer");                                                                         // 73
install("fortawesome:fontawesome");                                                                          // 74
install("natestrauser:x-editable-bootstrap");                                                                // 75
install("twbs:bootstrap-noglyph");                                                                           // 76
install("gwendall:body-events");                                                                             // 77
install("lai:collection-extensions");                                                                        // 78
install("dburles:mongo-collection-instances");                                                               // 79
install("babrahams:editable-text");                                                                          // 80
install("djedi:sanitize-html");                                                                              // 81
install("babrahams:editable-text-wysiwyg");                                                                  // 82
install("babrahams:editable-text-wysiwyg-bootstrap-3");                                                      // 83
install("chriswessels:hammer");                                                                              // 84
install("webapp");                                                                                           // 85
install("livedata");                                                                                         // 86
install("hot-code-push");                                                                                    // 87
install("fastclick");                                                                                        // 88
install("mobile-status-bar");                                                                                // 89
